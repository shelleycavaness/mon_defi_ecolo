...
func actionDB (){
    ...
    actions.append(Action(title: "Utiliser du vinaigre blanc pour tout nettoyer", done: false, description: "Utiliser du vinaigre blanc pour tout nettoyer", image: UIImage(named: "repairMachine")!, impact: "Mr Propre = 30g de Benzisothiazolinone", points: 200, dates: Date(), nbTimes: 0))
